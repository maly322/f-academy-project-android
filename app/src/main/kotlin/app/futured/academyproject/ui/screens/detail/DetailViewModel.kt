...
class DetailViewModel @Inject constructor(
    ...
    val setFavoritePlaceUseCase: SetFavoritePlaceUseCase,
...
//        setFavoritePlaceUseCase.build(args = viewState.placeId)

        setFavoritePlaceUseCase.execute(args = viewState.placeId){
            onSuccess {  }
        }
